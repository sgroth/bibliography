...
\printbibliography[type=book,notkeyword=vip,notkeyword=submitted,notkeyword=inpreparation,notkeyword=miszelle,keyword=monography,title={Monographien}]
\printbibliography[type=book,notkeyword=vip,notkeyword=miszelle,notkeyword=notaccepted,keyword=editedvolume,title={Herausgeberschaften}]
\printbibliography[keyword=specialissue,notkeyword=vip,notkeyword=inpreparation,title={Sondernummern von Zeitschriften}]
\printbibliography[nottype=periodical,notkeyword=vip,notkeyword=notaccepted,keyword=peerreview,title={Peer Reviewed Papers}]
...
%\printbibliography[keyword=notaccepted,notkeyword=vip,keyword=inpreparation,title={Beitr\"age in Vorbereitung}]
