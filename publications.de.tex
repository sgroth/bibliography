...
\printbibliography[notkeyword=submitted,notkeyword=inpreparation,notkeyword=miszelle,keyword=specialissue,title={Herausgabe von Sondernummern von Zeitschriften
}]
...
\printbibliography[keyword=miszelle,notkeyword=inpreparation,title={Miszellen}]
